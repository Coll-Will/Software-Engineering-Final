	...
	function pagenavbar()
	{
		if(isset($_SESSION['sessionID']))
		{
			/*$loginIcon ="<div class = \"login-container\">
			    			<a href=\"http://whereswalldo.000webhostapp.com/logout.php\" class=\"w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white\">Logout</a>
			    		</div>";*/
			$loginIcon = "<div class = \"login-container\">
			    			<a href=\"Client Account Login/logout.php\" class=\"w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white\">Logout</a>
			    		</div>";
		}
		else{
			/*$loginIcon = "<div class = \"login-container\">
			...
			$loginIcon = "<div class = \"login-container\">
			    			<a href=\"login.php\" class = \"w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white\">Signup / Login</a>
			    		 </div>";
		}
