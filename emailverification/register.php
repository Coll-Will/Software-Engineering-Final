...
$query="insert into userregistration(name,email,password,activationcode,status) values('$nameverify','$emailverify','$passwordverify','$activationcodeverify','$statusverify')";
...
<div style='padding-top:10px;'><a href='http://localhost/emailverify/email_register.php?code=$activationcodeverify'>Click Here</a></div>
