...
<head>
    ...
    <link rel="stylesheet" href="payment.scss">
</head>
<body>
    <div class="wrapper">
        <div class="container">
        ...
        ?>
            ...
            <form action="./placeOrder.php" method = "post">
                ...
                <div class="cc-num">
                    ...
                    <input type="number" name="cc-num" required>
                </div>
                <div class="cc-info">
                    <div>
                ...
                <div class="btns">
                    ...
                    <input type="button" value="Go Back" class="btn btn-primary" id="backBtn" onclick="document.location.href='./index.php'">
                </div>
            </form>
        </div>
    </div>
