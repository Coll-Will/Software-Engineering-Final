...
Above: Loads in the navigation bar for all navigation links. Also checks whether a user is logged in before allowing the page to be loaded
Below:-->
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <script type = "text/javascript">getOrder();</script> <!-- Puts the order information inot the order field -->
